  ...
  <div className="navbar-start">
    ...
    <NavLink to="/">
                    <div className="flex items-center gap-1">
                        ...
                        <h1 className="lg:text-xl text-xs text-blue-950 font-extrabold"><span className="text-3xl">C</span><span className="text-purple-600">raft</span><span className="font-semibold text-pretty">DEN</span></h1>
                    </div>
                </NavLink>
  </div>
